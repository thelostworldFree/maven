...
var loadLayer, backLayer, resultLayer, clickLayer,selfBitmap,enemyBitmap;
var imgList;
...
var imgData = new Array({name:"title",path:"title.jpg"},
...
function gameInit() {
	...
	backLayer.graphics.drawRect(10,'#008800',[0,0,LGlobal.width,LGlobal.height],true,'#ffffff');
